...
import com.example.billionemotosappkt.desktop.admin.screens.PlanosSection
...
import com.example.billionemotosappkt.desktop.admin.tickets.screens.TicketsSection
...
fun SectionContent(
    ...
    when (section) {
        ...
        AdminSection.PLANOS -> PlanosSection(api = api)
        ...
        AdminSection.TICKETS -> TicketsSection(
            api = api,
            apiBaseUrl = apiBaseUrl,
            apiAccessToken = apiAccessToken,
            compact = compact,
