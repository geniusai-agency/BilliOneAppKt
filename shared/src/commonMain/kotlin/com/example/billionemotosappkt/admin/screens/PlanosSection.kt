...
import com.example.billionemotosappkt.shared.utils.currentYearMonth
import com.example.billionemotosappkt.shared.utils.previousYearMonth
...
fun PlanosSection(
    ...
    val ymNow = remember { currentYearMonth() }
    val ymPrev = remember(ymNow) { previousYearMonth(ymNow) }
