...
enum class AdminSection(
    ...
    TICKETS("Chamados", "Suporte, manutenção e ajuda solicitados pelos clientes."),
...
val adminNavItems = listOf(
    ...
    AdminNavItem(AdminSection.TICKETS, "Chamados", Icons.Default.SupportAgent),
